...
from simple_color import SimpleColor, EnvParams
...
config = {
    ...
    "MAX_GRAD_NORM": 0.5,
    "ACTIVATION": "tanh",
    "ENV_PARAMS": EnvParams(max_colors=3, optimal_reward=1.0, suboptimal_reward=0.5, max_steps_in_episode=1),
    "ANNEAL_LR": True,
}
...
plt.plot(returns)
plt.title("PPO Learning Curve for SimpleColor Environment")
